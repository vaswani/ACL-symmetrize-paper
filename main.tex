...
\author{Tomer Levinboim \\
  ...
  {\tt tomer.levinboim.1@nd.edu} \\\And
  Ashish Vaswani \\
...
(2)~On Japanese-to-English back-transliteration without parallel data, applied to the decipherment model of Ravi and Knight, \method{MIR} learns sparser models that close the gap in whole-name error rate by 33\% relative to a model trained on parallel data, and further, beats a previous approach by \newcite{Mylonakis2007}.
