...
Another interesting direction is to design a regularizer that rewards more abstract notions of invertibility, that is, not only mapping tokens back to themselves, but also rewards invertibility across different word senses and synonyms.
