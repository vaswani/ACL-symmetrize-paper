...
(as opposed to through their inferences, as in Liang et al.'s Alignment by Agreement (\method{ABA})), our method seamlessly extends to all IBM-style word alignment models as well as to alignment \emph{without} parallel data.
...
(1)~On word alignment, applying \method{MIR} on fertility based models we attain higher F-scores than \method{ABA}.
