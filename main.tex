...
We derived an efficient MAP-EM algorithm and demonstrated our method's effectiveness on two different alignment tasks. On word alignment, \method{MIR} yielded \bleu improvements comparable to the Alignment by Agreement method \cite{liang+:2006:align}, and complementary, so that combining the produced alignments yielded further improvement (up to 1.5 \bleu).
...
Another promising direction is to encourage invertibility not only between words, but between their senses and synonyms.
%\section*{Appendix}
