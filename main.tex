...
By coupling the two models through their parameters (as opposed to through their inferences, as in Liang et al.'s Alignment by Agreement (\method{ABA}) method), our method remains applicable to all IBM-style alignment models and as well as to alignment without parallel data.
