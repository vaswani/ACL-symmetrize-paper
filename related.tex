...
&=\log \prod_n \sum_\ve p(\ve) \prod_{m} t_1(\vf^n_m\mid\ve).
\end{align*}
...
an approximation of their M-step objective which omits normalization factors.\marginpar{DC: Will motivated readers be able to understand what ``omit normalization factors'' means?}
