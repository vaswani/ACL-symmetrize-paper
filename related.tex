...
Specifically, they add a KL-projection step after the E-step of the EM algorithm which returns the posterior $q(z\mid x)$ closest to ordinary E-step posterior (in the KL sense) but that also upholds certain constraints. 
The particular constraints they suggest encode alignment agreement \emph{in expectation} between the two model' posteriors. See details in their paper \cite{ganchev-gracca-taskar:2008}. 
