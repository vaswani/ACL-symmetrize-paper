...
To remedy this disparity (and other shortcomings), it is common to turn to alignment symmetrization techniques such as grow-diag-final-and \cite{koehn+:2003} which heuristically combine alignments from both directions.
...
Second, a single implementation extends to all IBM models, including the fertility based models.
