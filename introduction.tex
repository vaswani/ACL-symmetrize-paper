...
For example, in transliteration, a source-language word is mapped to a different language's writing system under a sound preserving mapping (say,``computer'' to Japanese Romaji, ``konpyutaa''). The original word should then be easily recoverable from its transliterated version.
...
\marginpar{DC: Consider mentioning MIR before ABA}
