...
\newcite{RK09} train English-to-Japanese transliteration models using monolingual (Japanese) data only.\marginpar{DC: They use an English language model, though, right?}
Unfortunately, the resulting model considerably underperforms the same model trained on parallel data.
