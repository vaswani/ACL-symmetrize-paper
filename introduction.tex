...
In \cite{RK09} the authors train English-to-Japanese transliteration models in the decipherment setting \cite{Knight06}  - that is, using monolingual (Japanese) data only.
...
Compared to ABA, our approach operates with a different measure of agreement in mind (Section \ref{sec:method}).
