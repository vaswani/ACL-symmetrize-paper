...
A simple generative process usually involves an entity-to-entity translation table, denoted $t$, that defines the probability of mapping a single source entity $\ve$ to a single target entity $\vf$ (for example, the IBM model word-for-word translation table \cite{brown+alii:1993}).
