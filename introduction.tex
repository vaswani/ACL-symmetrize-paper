...
Our approach has several benefits over \method{ABA}:
...
Finally, as \method{MIR} follows the EM framework, it inherits its desirable theoretical convergence guarantees.
