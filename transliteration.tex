...
\item An English pronunciation FST from the CMU pronunciation dictionary\footnote{http://www.speech.cs.cmu.edu/cgi-bin/cmudict}. %(REFERENCE?).
...
Vanilla EM training of the baseline was done using the Carmel finite-state toolkit\footnote{http://www.isi.edu/licensed-sw/carmel/}.% \cite{graehl97}.
