...
EM training of the baseline pipeline was done using the Carmel finite-state toolkit \cite{graehl97}.
...
Finally, to compare against the ordinary parallel data setting, we used Carmel to train the English-to-Japanese phoneme mapping model $t_1$ over 4.2K pairs of English and Japanese phoneme sequences.
