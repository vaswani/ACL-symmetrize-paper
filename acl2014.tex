...
(2) On Japanese-to-English back-transliteration \emph{without} parallel data, our method, applied to the decipherment model of Ravi and Knight, learns sparser models that reduce whole-name error rate by 33\% relative to a model trained on parallel data.
\end{abstract}
