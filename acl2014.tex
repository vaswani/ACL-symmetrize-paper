...
\maketitle
\begin{abstract}
  We present a simple approac`h that encourages jointly trained conditional models to agree on their parameter values. In contrast to methods that encourage agreement on inferences, our method can be applied even without parallel data. 
