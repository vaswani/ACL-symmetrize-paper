...
We propose an unsupervised approach for jointly learning bi-directional alignment models by means of maximizing both their data likelihoods and a measure of model agreement.
