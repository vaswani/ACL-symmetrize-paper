...
\maketitle
\begin{abstract}
Learning how to align sequences is a key problem in natural language processing.
...
\textbf{In word alignment in particular, it is common practice to train models in both directions and apply symmetrization heuristics.}
...
On Czech-English word alignment, we obtain +0.4 BLEU compared to GIZA++ alignments, and combining with alignments from Liang et al.'s model brings the total improvement to +0.8 BLEU.
...
\section{Conclusion}
We presented the Parameter Agreement Training (PAT) formulation. 
