...
The generative story assigns the following probability to the event that $\vf$ arises from~$\ve$:\marginpar{DC: one way to fix the abuse of notation is to explicitly write $p(\ve)$ here.}
\begin{equation}
