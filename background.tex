...
is to formulate a generative story that describes transformations of strings from a source language $L_{E}$ to a target language $L_{F}$. 
The generative story explicitly construct conditional probability distributions of the form $P(f\mid e)$ where $e$ is an entity from $L_{E}$ and $f$ is a string from $L_{F}$.
