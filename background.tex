...
\end{equation}
I.e., an observed $\vf$ can arise from any sequence $\ve$ by first selecting $\ve \sim p(\ve)$ and then proceeding according to the parallel data generative story.

Unsupervised training of such models entails maximizing the log-likelihood $L(\Theta)$:
\begin{align*}
