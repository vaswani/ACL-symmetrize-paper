...
\end{equation}
That is, the sequence $\vf$ can arise from any sequence $\ve$ by first selecting $\ve \sim p(\ve)$ and then proceeding according to the parallel-data generative story (\ref{eqn:parallel}).
