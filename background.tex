...
We are concerned with learning generative models that describe transformations of a source-language entity $\ve$ to a target-language entity $f$.
...
The generative story for the transformation of $e$ to $f$ follows according to \eqn{eqn:parallel} where the hidden variable $a = (a_1, \ldots, a_J)$ corresponds to a sequence of $J$ indices and encodes an asymmetric target-to-source alignment under which the $j$th target word is aligned to the $a_j$th source word. 
