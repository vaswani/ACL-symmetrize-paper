...
Although the structure of $\Theta$ is unspecified, in practice, most models that follow these generative stories contain a source-to-target translation table (``t-table'') denoted $t$, with each parameter $t(f\mid e)$ representing the conditional probability of mapping a given source symbol $e$ to a target symbol~$f$.
