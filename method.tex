...
We follow Liang et al. (2006) in formulating a joint objective function for training the two directional alignment models. We adopt similar notation denoting the source-to-target direction with subscript 1 and the target-to-source direction with subscript 2 but diverge when necessary.
