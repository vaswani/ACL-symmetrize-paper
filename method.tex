...
Owing to the concavity of both $R$ and the data log-likelihood functions, the M-step maximization problem is also efficiently solvable using convex programming techniques. We used our own projected gradient descent implementation. At each step, the current $(\TA, \TB)$ parameters are updated according to the gradient of the objective \eqn{eqn:joint}, and then projected back onto the probability simplex.
