...
\noindent
where the expected counts were computed in the E-step. Since we only encourage agreement between the translation probabilities, the estimation of the distortion probabilities is left unchanged. We leave agreement training of the distortion parameters for future work. 
