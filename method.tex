...
Showing significant reductions in AER they demonstrate the effectiveness of jointly learning the models.
...
Note that only the $t_\cdot$ parameters are coupled through $R$.
