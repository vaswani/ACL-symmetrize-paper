...
Specifically, in the parallel data setting, the probability of $\vx_k^n$ under its model is:\footnote{This slight notational abuse helps represent both data scenarios succinctly.}
%\marginpar{DC: I don't even see where the notational abuse is.}
\begin{align*}
