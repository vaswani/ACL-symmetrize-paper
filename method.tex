...
\end{align*}
with $k\in\set{1,2}$ and $n$ ranging over the appropriate set of samples. For word alignment and transliteration, the above objective function can be defined in term of the expected counts as:
\begin{align*}
