...
To solve \eqn{eqn:Mobj} we applied Projected Gradient Descent \cite{bertsekas1999nonlinear}, where at each step, the parameters are updated in the direction of the M-step objective gradient at $(\tA, \tB)$ and then projected back onto the probability simplex. 
