...
\item[Chinese-English:] 155K sentence pairs from the NIST 2009 Open MT Evaluation constrained task.
\item[Czech-English:] 85K sentence pairs from the News Commentary corpus.
\end{description}
...
For IBM model 4, we used the standard grow-diag-final-and (gdfa) symmetrizaition heuristic~\cite{koehn+:2003}.
