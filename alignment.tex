...
In this section, we will present our results on using parameter agreement training for word alignment. 

\begin{table*}
\begin{center} \small
\renewcommand{\arraystretch}{1.1}
\begin{tabular}{cc|c|c|l|l|lll}
...
\multirow{3}{*}{Chi-Eng} & \multirow{3}{*}{9.6+12} & baseline & 64.6  &  23.6 & & \\
        ...
        &       & ABA+PAT  &    & 24.5 (+0.9) & \\
\hline
\multirow{3}{*}{Cze-Eng} & \multirow{3}{*}{2.1+2.3} & baseline & 65.0 & & 16.7 & 17.1  \\
