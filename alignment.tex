...
\subsection{Training}
Following standard practice, we first trained our word alignment models on the following parallel data and then trained a phrase based translation :
\begin{itemize}
