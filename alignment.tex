...
We carried out Czech-English and Chinese-English word alignment and MT experiments comparing $\method{MIR}$ against standard EM training and $\method{ABA}$.
...
\begin{itemize}
\item \textbf{Chinese-English}: ?K sentence pairs from the NIST 2009 Open MT Evaluation constrained task.
\item \textbf{Czech-English}: 85K sentence pairs from the News Commentary corpus.
\end{itemize}
