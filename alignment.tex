...
Table~\ref{tab:resultsF} summarizes our MT \bleu score results.
...
\end{tabular}
%\end{center}
\caption{Word alignment F1 scores. \method{MIR} with IBM model 4 attains higher F scores compared to \method{ABA}.}
\label{tab:resultsF}
\end{table}
