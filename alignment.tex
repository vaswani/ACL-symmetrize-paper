...
We restricted the sentence length in our parallel data to at most $40$. For both vanilla EM  and ABA training, we used the publicly available word alignment toolkits that implement them. 
