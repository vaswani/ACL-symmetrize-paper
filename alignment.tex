...
\end{tabular}
\end{center}
\caption{For Czech-English, the year refers to the WMT shared task; for Chinese-English, the year refers to the NIST Open MT Evaluation. Both ABA and PAT obtain statistically significant results over vanilla EM training, and combining ABA and PAT alignments also improves \bleu{} score significantly, with $p<0.05$ for both. The \bleu{} difference between ABA and PAT is not statistically significant.  }
\label{tab:results}
\end{table*}
